...
def get_mode(device_filter):
    ...
    from .device_filters import IBeaconFilter, EddystoneFilter, BtAddrFilter, EstimoteFilter, \
                                CJMonitorFilter, ExposureNotificationFilter, RuuviTagFilter  # pylint: disable=import-outside-toplevel
    ...
    for filtr in device_filter:
        ...
        elif isinstance(filtr, RuuviTagFilter):
            mode |= ScannerMode.MODE_RUUVITAG
